export default function renderSloth(color: string, id: number): void {
  const slothDiv: HTMLDivElement = document.createElement('div');
  const garageEl: HTMLDivElement | null = document.querySelector(`.garage-el-bot-${id}`);
  if (garageEl) {
    garageEl.append(slothDiv);
    slothDiv.classList.add('sloth-wrapper');
    slothDiv.id = `sloth-${id}`;
    slothDiv.innerHTML = `<?xml version="1.0" standalone="no"?>
    <!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 20010904//EN"
     "http://www.w3.org/TR/2001/REC-SVG-20010904/DTD/svg10.dtd">
    <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
     width="111.000000pt" height="31.000000pt" viewBox="0 0 311.000000 211.000000"
